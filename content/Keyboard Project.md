...
This is the list for a ferris sweep build, not my final decision, but likely
- JCL PCB (Modified from the [sweep2 PCB](https://github.com/davidphilipbarr/Sweep))
- 2x TRRS Jacks
- 2x Microcontrollers
- 34x Switches (Kailh Choc)
- 34x Keycaps
- 1x USB Cable
- 1x TRRS Cable 

![[yesclaudewtvyousay.png]]
