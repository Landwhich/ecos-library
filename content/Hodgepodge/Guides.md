...
| 2026 | ▮▮▮ | ▮▮ |  |
### Online Guides
- [ ] <span class="rate-n">[Beej(Goat)'s C Guide](https://beej.us/guide/bgc/)</span>
- [ ] <span class="rate-n">[Debugging with GDB](https://tinyurl.com/yddkushh)</span>
- [ ] <span class="rate-n">[Discover Three.js](https://discoverthreejs.com/book/introduction/)</span>
- [ ] <span class="rate-n">[Introduction to 3D Game Programming with Direct 3D 12](https://d3dcoder.net/d3d12_v2.htm)</span> following by recommendation and translating into Vulkan.
