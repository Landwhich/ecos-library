...
- [x] <span class="rate-5">Can't Hurt Me - **David Goggins**</span> Very simply one of my favourite reads. Just read it if you haven't yet. Takeaways: Silencing your governor, Subconscious limiter, Cookie jar, Train Hard to think hard, Seek discomfort
...
- [x] <span class="rate-1">The C Programming Language - **Brian Kernighan, Dennis Ritchie**</span> This is not the ansi version, therefore incredibly out of date (variables still need to be declared outside loops). Cool pocket ref (if it were smaller), and interesting artifact to have read.
