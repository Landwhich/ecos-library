...
- [ ] <span class="rate-n">Beyond Good and Evil - **Friedrich Nietzche**</span>
- [ ] <span class="rate-n">C++ Concurrency in Action - **Anthony Williams**</span>
- [ ] <span class="rate-n">C++ Software Design - **Klaus Iglberger**</span>
- [ ] <span class="rate-n">C Programmer's Guide to Serial Communications - **Joe Campbell**</span>
- [x] <span class="rate-5">Can't Hurt Me - **David Goggins**</span> Very simply one of my favourite reads. Just read it if you haven't yet. Takeaways: Silencing your governor, Subconscious limiter, Cookie jar, Train Hard to think hard, Seek discomfort. Genuine raw storytelling and advice from someone qualified to lecture.
- [ ] <span class="rate-n">Computer Systems (A Programmer's Perspective) - **Bryant O'Hallaron**</span>
...
- [ ] <span class="rate-n">Men Among Ruins - **Julius Evola**</span>
- [x] <span class="rate-2">Neuroplasticity - **MIT Press (Moheb Constandi)**</span> A lot less technical than expected from MIT Press, though wonderfully brief and explains some interesting research at a very high level.
...
- [ ] <span class="rate-n">The Brothers Karamazov - **Fyodor Dostoevsky**</span>
- [x] <span class="rate-3">The Charisma Myth - **Olivia Fox Cabane**</span> Overly verbose, and yet still dense with information on charisma best practices. Takeaways: Confidence changes appeal (prepare, dress, posture), Balance goodness with assertiveness and selfishness, 
- [ ] <span class="rate-n">The Count of Monte Cristo - **Alexandre Dumas**</span>
- [ ] <span class="rate-n">The Courage To Be Disliked - **Ichiro Kishimi**</span>
- [x] <span class="rate-1">The C Programming Language - **Brian Kernighan, Dennis Ritchie**</span> This is not the ansi version, therefore incredibly out of date (variables still need to be declared outside loops and more fun). Cool pocket ref (if it were smaller), and interesting artifact to have read.
- [ ] <span class="rate-n">The Epic of Gilgamesh</span>
- [ ] <span class="rate-n">The Grapes of Wrath - **John Steinbeck**</span>
- [x] <span class="rate-4">The Illiad - **Homer**</span> ***The*** Epic for sure. I think this one is a lot more forthright than *The Odyssey* in Homer's attempt to discuss morality and nuanced ideas. I found it quite long-winded, and still it kept me engaged throughout. The payoff with Achilles wasn't as satisfying as expected, but I imagine that's by design. Reflections at the end on revenge were possibly novel at the time and abuse of gods' power is interesting to explore. *(translated by Robert Fagles; great)*
- [x] <span class="rate-4">The Odyssey - **Homer**</span> I'm no historian or linguist, but it's easy see how opinions of this book differ from those to *The Illiad*, The writing style clearly changes from that used in the previous book. The dynamic between hero and god is as perfect as expected and finishes the original book off perfectly. The fact the book kept my so engaged despite its archaic language is a testament to the exceptional story-telling *(translated by Robert Fagles; great)*
- [ ] <span class="rate-n">The Old man and the Sea - **Ernest Hemingway**</span>
- [ ] <span class="rate-n">The Pearl - **John Steinbeck**</span>
- [ ] <span class="rate-n">The Pragmatic Programmer - **David Thomas, Andrew Hunt**</span>
...
- [ ] <span class="rate-n">10 - [The Art of Writing Efficient Programs](https://github.com/PacktPublishing/The-Art-of-Writing-Efficient-Programs) - **Fedor G. Pikus**</span>
...
- [ ] <span class="rate-n">July - Nicomachean Ethics - **Aristotle**</span>
- [x] <span class="rate-n">August - The Illiad - **Homer**</span>
...
- [ ] <span class="rate-n">April - The Epic of Gilgamesh</span>
- [ ] <span class="rate-n">May - Discourses on Methods and the Meditations - **Descartes**</span>
- [ ] <span class="rate-n">June - Free - (  - ****)</span>
- [ ] <span class="rate-n">July - Men Among Ruins - **Julius Evola**</span>
- [ ] <span class="rate-n">August - The Odyssey - **Homer**</span>
- [ ] <span class="rate-n">September - Free - (  - ****)</span>
- [ ] <span class="rate-n">October - The Count of Monte Cristo - **Alexandre Dumas**</span>
- [ ] <span class="rate-n">November - The Prince - **Machiavelli**</span>
